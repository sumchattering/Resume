...
\item
    ...
    \begin{itemize}
        ...
        \resitem{Contributed to several C++ cross platform projects}
    \end{itemize}

\item
    \ressubheading{\href{http://www.icemobile.com}{IceMobile Agency \texttt{(Digital Agency)}}}{Amsterdam, The Netherlands}{Senior iOS Engineer}{February 2014 - November 2014}
    \begin{itemize}
...
\item
    \ressubheading{\href{http://www.ebuddy.com}{Ebuddy \texttt{(Chat)}}}{Amsterdam, The Netherlands}{iOS Developer}{June 2013 - January 2014}
    \begin{itemize}
...
\item
    \ressubheading{\href{http://www.microstrategy.com/Company}{MicroStrategy Inc. \texttt{(Business Intelligence)}}}{McLean,VA}{Software Engineer}{September 2010 - January 2012}
    \begin{itemize}
...
\item
    \ressubheading{Citisync \texttt{(Event Management)}}{Gainesville,FL}{iOS Developer}{January 2010- July 2010}
    \begin{itemize}
...
\item
    \ressubheading{\href{http://www.bloomberg.com}{Bloomberg LP} \texttt{(Financial Services)}}{New York,NY}{Financial Software Development Intern}{May 2009 - August 2009}
    \begin{itemize}
...
\begin{description}
\item[Languages:]
Swift, Objective C, C, C++, Python, Bash, Javascript(Node.js)
\item[Technical Skills:] iOS, Serverless, Machine Learning
...
\begin{description}
\item Pilot Training, Crossfit, Salsa, Travel, Pool and Snooker
\end{description}
